...
const JUGADORAS = [
  {
    ...
    posicion: "",
    pais: "IT",
    foto: "assets/annikapaz.png",
    afiliaciones: [
      { nombre: "Inter de Milán", escudo: "assets/inter-annika.png" },
      { nombre: "Selección Femenina Argentina", escudo: "assets/annika_afa.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "BR",
    foto: "assets/maricel.png",
    afiliaciones: [
      { nombre: "São Paulo", escudo: "assets/saopablo.png" },
      { nombre: "Selección Femenina Argentina", escudo: "assets/annika_afa.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/agussanchez.png",
    afiliaciones: [
      { nombre: "Belgrano de Córdoba", escudo: "assets/belgranoescudo.png" },
      { nombre: "Selección Femenina Uruguaya", escudo: "assets/uruguayescudo.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/caroceniza.png",
    afiliaciones: [
      { nombre: "River Plate", escudo: "assets/riverescudo.png" },
      { nombre: "Selección Femenina Argentina", escudo: "assets/annika_afa.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "CL",
    foto: "assets/vaitiareprado.png",
    afiliaciones: [
      { nombre: "Universidad Católica", escudo: "assets/uca.png" },
      { nombre: "Selección Femenina de Chile", escudo: "assets/chile-fedefutbol.png" },
    ],
  },
  {
  ...
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/catadosreis.png",
    afiliaciones: [
      { nombre: "Talleres de Córdoba", escudo: "assets/talleres.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "IT",
    foto: "assets/taborda.png",
    afiliaciones: [
      { nombre: "Donna Roma", escudo: "assets/donnaroma.png" },
    ],
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/paffundi.png",
    afiliaciones: [
      { nombre: "San Lorenzo de Almagro", escudo: "assets/casla.png" },
    ],
  },
  {
  ...
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/acetelgaray.png",
    afiliaciones: [
      { nombre: "Club Atlético Huracán", escudo: "assets/huracan.png" },
    ],
  },
  {
  ...
  },
  {
    ...
    posicion: "",
    pais: "AR",
    foto: "assets/albertina.png",
    afiliaciones: [
      { nombre: "Boca Juniors", escudo: "assets/bocaescudo.png" },
    ],
  },
  {
